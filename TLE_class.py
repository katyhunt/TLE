...
class TLE(object):
    ...
    initialization parameters:
        name="Satellite" (String)
            max 24 characters
        sat_num=0 (int)
            satellite number, max 5 characters
        classification="U" (String)
            1 character
        int_designator="000000" (String)
